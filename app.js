document.addEventListener("DOMContentLoaded", function() {
    ...
    saveTaskBtn.addEventListener('click', function() {
      ...
      if (taskText !== '') {
        ...
        edit.innerHTML = '<i class=\"fa-solid fa-pen\" style=\"color: #ffffff;\"></i>';
        complete.classList.add("complete");
        complete.innerHTML = '<i class="fa-regular fa-circle" style="color: #ffffff;"></i>';
    ...
    taskList.addEventListener('mouseover', function(event) {
      ...
      if (target.classList.contains('complete')) {
        target.addEventListener("mouseenter", function() {
          target.innerHTML = "<i class=\"fa-regular fa-circle-check\" style=\"color: #ffffff;\"></i>";
        });
      }
    });
    ...
    taskList.addEventListener('mouseout', function(event) {
      ...
      if (target.classList.contains('complete')) {
        target.addEventListener("mouseleave", function() {
          target.innerHTML = "<i class=\"fa-regular fa-circle\" style=\"color: #ffffff;\"></i>";
        });
      }
    });
